import { Component, CSSProperties, createRef, UIEvent, MouseEvent, PropsWithChildren } from 'react';
import styled from 'styled-components';
import { ElementLayout, ensureWithinLimits, isEventPosOnDomNode, isEventPosOnLayout, simpleDebounce } from './utils';
...
export class CustomScroll extends Component<CustomScrollProps, CustomScrollState> {
    ...
    render() {
        ...
        return (
            <CustomScrollRoot id="pro-layout" className={className} style={rootStyle} ref={this.customScrollRef}>
                <div
                ...
                >
                    {this.hasScroll ? (
                        <div className="rcs-positioning">
                            ...
                            >
                                ...
                                >
                                    <ScrollHandle className={this.props.handleClass || 'rcs-inner-handle'} />
                                </div>
                            </CustomScrollbar>
                        </div>
                    ) : null}
                    ...
                    >
                        <div ref={this.contentWrapperRef} style={scrollStyles.contentWrapper}>
                            {this.props.children}
                        </div>
                    </div>
                </div>
